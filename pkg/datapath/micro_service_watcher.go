...
func (ms *microServiceBRWatcher) Init(ctx context.Context, _ interface{}) error {
...
func (ms *microServiceBRWatcher) StartBackup(source AccessPoint, _ map[string]string, _ interface{}) error {
