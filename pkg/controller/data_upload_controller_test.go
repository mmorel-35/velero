...
func (f *fakeSnapshotExposer) Expose(ctx context.Context, _ corev1.ObjectReference, _ interface{}) error {
...
func (f *fakeSnapshotExposer) GetExposed(ctx context.Context, _ corev1.ObjectReference, _ time.Duration, _ interface{}) (*exposer.ExposeResult, error) {
	pod := &corev1.Pod{}
	err := f.kubeClient.Get(ctx, kbclient.ObjectKey{
		Name:      dataUploadName,
		Namespace: velerov1api.DefaultNamespace,
...
func (f *fakeDataUploadFSBR) Init(_ context.Context, _ interface{}) error {
	return f.initErr
}

func (f *fakeDataUploadFSBR) StartBackup(_ datapath.AccessPoint, _ map[string]string, _ interface{}) error {
	return f.startErr
}
